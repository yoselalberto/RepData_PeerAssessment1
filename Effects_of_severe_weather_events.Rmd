...
I explored the U.S. *NOAA*'storm database, focusing in the health, and economic impact during the 1996 - 2011 period. I found that **excessive heat** is responsible for more deaths that any other weather event, followed closely by **tornadoes**; by the way, *tornadoes* provoque more injuries that any other event, by far. In terms of economic impact, the **hurricanes** lead, by a lot, to more economic damage than any other event, specially in crops.
